    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full">
            ...
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-sm text-gray-600">Sistem Pengaduan Kampus</p>
            </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" value="{{ old('email') }}" required autofocus
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition @error('email') border-red-500 @enderror"
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-xs text-blue-700">
                            Gunakan email kampus Anda untuk login. Jika mengalami kendala, hubungi admin.
                        </p>
                    </div>
                </div>
            </div>
