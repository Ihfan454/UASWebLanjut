...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            <div class="navbar-brand">🎓 Smart Campus</div>
            ...
            <div class="navbar-menu">
                ...
                {{-- Logout (kalau breeze ada). kalau gak ada breeze, ini aman karena ada fallback --}}
                @if(Route::has('logout'))
    ...
    <div class="container">
        ...
        <div class="content-box">
            <div class="content-header">
                <h2 class="content-title">Daftar Pengaduan Terbaru</h2>
